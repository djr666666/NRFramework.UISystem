...
namespace NRFramework
{
    ...
    public abstract partial class UIView 
    {
        ...
        protected virtual void OnRemoveApplicationPause(Action<bool> remove) => viewBehaviour.onApplicationPause -= remove;

        protected virtual void OnAddApplicationFocus(Action<bool> add) => viewBehaviour.onApplicationFocus += add;

        protected virtual void OnRemovedApplicationFocus(Action<bool> remove) => viewBehaviour.onApplicationFocus -= remove;
        ...
        /// <summary>取消Upadte </summary>
        protected virtual void OnRemoveFixUpdate(Action remove) { if (viewBehaviour != null) viewBehaviour.onFixUpdate -= remove; }
